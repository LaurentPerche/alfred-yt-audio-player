...
* When large machine-generated output would bloat context, prefer the available Headroom MCP tools for compression and retrieve exact details only when needed.
